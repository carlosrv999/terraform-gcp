...
create user emojiuser@'%' IDENTIFIED BY 'DcS5Gb7Gs2W#';
grant all privileges on emoji.* to emojiuser@'%';
flush privileges;

create table emoji.emojis (id INTEGER NOT NULL PRIMARY KEY, emoji varchar(5) NOT NULL, description varchar(100));
